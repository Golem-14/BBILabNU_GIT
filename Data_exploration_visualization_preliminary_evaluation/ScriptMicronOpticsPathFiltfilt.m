...
pathToData = "C:\Users\User\Desktop\New Sensors Toheeb\Calibration Toheeb 01.12.25\SMF+NCF\Round 2"; %input path to your data
...
for ii = 1:kk
    CHF1(ii,:) = filtfilt(b,a,CH1(ii,:));
    if exist('CH2')
        CHF2(ii,:) = filtfilt(b,a,CH2(ii,:));
    end
    if exist('CH3')
        CHF3(ii,:) = filtfilt(b,a,CH3(ii,:));
    end
    if exist('CH4')
        CHF4(ii,:) = filtfilt(b,a,CH4(ii,:));
    end
    if exist('CH5')
        CHF5(ii,:) = filtfilt(b,a,CH5(ii,:));
    end
    if exist('CH6')
        CHF6(ii,:) = filtfilt(b,a,CH6(ii,:));
    end
    if exist('CH7')
        CHF7(ii,:) = filtfilt(b,a,CH7(ii,:));
    end
    if exist('CH8')
        CHF8(ii,:) = filtfilt(b,a,CH8(ii,:));
    end
end
