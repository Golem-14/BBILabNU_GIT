...
%%% Filter data
for ii = 1:kk
    CHF1(ii,:) = wdenoise(CH1(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
    CHF2(ii,:) = wdenoise(CH2(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
    CHF3(ii,:) = wdenoise(CH3(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
    CHF4(ii,:) = wdenoise(CH4(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
    CHF5(ii,:) = wdenoise(CH5(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
    CHF6(ii,:) = wdenoise(CH6(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
    CHF7(ii,:) = wdenoise(CH7(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
    CHF8(ii,:) = wdenoise(CH8(ii,:), 5, ...
        'Wavelet', 'sym4', ...
        'DenoisingMethod', 'Bayes', ...
        'ThresholdRule', 'Median');
end
