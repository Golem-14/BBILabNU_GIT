Scripts for using random points instead of peaks and valleys. Under development.

This folder is dedicated to the PROJECT  Random points on the spectrum (instead of peaks and valleys) 

developer: L. Vassilets
if you want to participate please contact me: lyubov.vassilets@alumni.nu.edu.kz
...
#### 1 FunctionCalibRandPath
Original calibration script modified to detect random points instead of peaks and valleys.
