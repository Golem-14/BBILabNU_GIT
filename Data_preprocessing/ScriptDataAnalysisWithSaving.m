...
ChannelData = CHF6; %%% Replace here the channel you want to analyze

% Modification for probe signature application later
% refinepeaks(Intensity,4)
detection = "S7.2WATER";
code_name = "LV57";
chan = strcat(ChannelData);
probe_name = strcat('Detection_', detection, '_', code_name, '_', chan);
...
% Locs
%writematrix(LocPeakLeft, strcat(probe_name(1,:), 'LocPeakLeft', '.csv'))
%writematrix(LocPeakRight, strcat(probe_name(1,:), 'LocPeakRight', '.csv'))
%writematrix(LocValleyLeft, strcat(probe_name(1,:), 'LocValleyLeft', '.csv'))
%writematrix(LocValleyRight, strcat(probe_name(1,:), 'LocValleyRight', '.csv'))

% Responses
%writematrix(ResponsePeakLeft, strcat(probe_name(1,:), 'ResponsePeakLeft', '.csv'))
%writematrix(ResponsePeakRight, strcat(probe_name(1,:), 'ResponsePeakRight', '.csv'))
%writematrix(ResponseValleyLeft, strcat(probe_name(1,:), 'ResponseValleyLeft', '.csv'))
%writematrix(ResponseValleyRight, strcat(probe_name(1,:), 'ResponseValleyRight', '.csv'))
